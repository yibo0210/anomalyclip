...
## Phase 1: Multi-Scale Spatial Aggregation on MVTec AD
base_dir=${depth[0]}_${n_ctx[0]}_${t_n_ctx[0]}_multiscale
...
CUDA_VISIBLE_DEVICES=${device} python test.py --dataset mvtec \
    ...
    --features_list 12 --image_size 224 --depth ${depth[0]} --n_ctx ${n_ctx[0]} --t_n_ctx ${t_n_ctx[0]}
